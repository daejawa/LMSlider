...
namespace ublox_msgs
{
  ...
  class NavRELPOSNED : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 2) = (this->reserved1 >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->reserved1 >> (8 * 3)) & 0xFF;
      ...
      *(outbuffer + offset + 0) = (this->relPosHPLength >> (8 * 0)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += sizeof(this->relPosHeading);
      this->reserved1 =  ((uint32_t) (*(inbuffer + offset)));
      this->reserved1 |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->reserved1 |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->reserved1 |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      offset += sizeof(this->reserved1);
      union {
        int8_t real;
        uint8_t base;
      ...
      offset += sizeof(this->relPosHPD);
      this->relPosHPLength =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->relPosHPLength);
    ...
    virtual const char * getMD5() override { return "230f179ad5d03f7dffe9babdd98b23cc"; };
